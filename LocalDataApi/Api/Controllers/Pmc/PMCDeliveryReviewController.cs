...
public class PMCDeliveryReviewController : ControllerBase
{
    ...
    [HasPermission(PermissionCodes.DeliveryReviewView)]
    ...
    [HasPermission(PermissionCodes.DeliveryReviewApprove)]
    ...
    [HasPermission(PermissionCodes.DeliveryReviewUpdate)]
    ...
    [HasPermission(PermissionCodes.DeliveryReviewReject)]
