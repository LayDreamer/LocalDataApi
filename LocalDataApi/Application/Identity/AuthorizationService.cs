...
namespace LocalDataApi.Application.Identity
{
    ...
    public sealed class AuthorizationService
    {
        ...
        public async Task<bool> HasAnyPermissionAsync(long userId, IEnumerable<string> permissionCodes, CancellationToken ct = default)
        {
        ...
        /// </summary>
        public async Task<(List<string> Roles, List<string> Permissions)> GetUserRolesAndPermissionsAsync(long userId, CancellationToken ct = default)
        {
            var roles = await (
                from ur in _context.UserRoles
                join r in _context.Roles on ur.RoleId equals r.Id
